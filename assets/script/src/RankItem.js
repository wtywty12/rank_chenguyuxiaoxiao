...
var RankItem = (function (_super) {
    ...
    __decorate([
        property(cc.Label)
    ], RankItem.prototype, "lbl_paiming", void 0);
    __decorate([
        property(cc.Label)
    ], RankItem.prototype, "lbl_nickName", void 0);
    __decorate([
        property(cc.Label)
    ], RankItem.prototype, "lbl_winGame", void 0);
    __decorate([
        property(cc.Label)
    ], RankItem.prototype, "lbl_score", void 0);
    __decorate([
        property(cc.Sprite)
    ], RankItem.prototype, "img_head", void 0);
    RankItem = __decorate([
        ccclass
    ], RankItem);
    return RankItem;
