(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/src/top/liubowen/core/common/ResourcesManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '99f09349upMk6P8ySVM/eDP', 'ResourcesManager', __filename);
// script/src/top/liubowen/core/common/ResourcesManager.js
        ...
        return new Promise(function (fulfill, reject) {
            cc.loader.loadResDir("images", cc.SpriteFrame, function (error, datas, urls) {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    var data = datas[i];
                    cc.log("loadImages -> name : " + name_2 + " , data : ", data);
