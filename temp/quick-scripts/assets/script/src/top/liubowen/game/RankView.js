...
var RankView = function (_super) {
        ...
        wx.getUserInfo({
            ...
            success: function success(userRes) {
                ...
                wx.getFriendCloudStorage({
                    ...
                    success: function success(friendRes) {
    ...
    __decorate([property(cc.ScrollView)], RankView.prototype, "rankingScrollView", void 0);
    __decorate([property(cc.Prefab)], RankView.prototype, "rankItem", void 0);
    RankView = __decorate([ccclass], RankView);
    return RankView;
}(cc.Component);
