(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/src/ResourcesManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'dea08N4l3hL8bkNMhbJpyQT', 'ResourcesManager', __filename);
// script/src/ResourcesManager.js
            ...
            cc.loader.loadResDir("images", cc.SpriteAtlas, function (error, datas, urls) {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    if (data instanceof cc.SpriteFrame) {
                        console.log("loadSpriteAtlas -> name : " + name_3 + " , data : " + data);
        ...
        return new Promise(function (fulfill, reject) {
            cc.loader.loadResDir("prefabs", cc.Prefab, function (error, datas, urls) {
                ...
                for (var i = 0; i < datas.length; i++) {
                    ...
                    var data = datas[i];
                    console.log("loadPrefabs -> name : " + name_4 + " , data : " + data);
